...
import { vendorScripts, mainScripts, serviceWorkerScripts, serviceWorkerRegisterScripts } from './gulp-tasks/scripts.js';
...
export function watch() {
  ...
  gulp.watch(config.src + config.scripts + '**/*.js', gulp.series(mainScripts, vendorScripts, serviceWorkerScripts, serviceWorkerRegisterScripts));
}
...
const build = gulp.series(
  ...
  serviceWorkerRegisterScripts,
  svg,
  bitmap,
  sassGenerateContents,
  styles,
  criticalStyles,
  copyFonts
);
